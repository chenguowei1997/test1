	...
	<div class="wrapper">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="删除" onclick="deleteUserByIds()">
									...
									<c:forEach items="${userList}" var="user">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/user/findUserById/${user.id}" class="btn bg-olive btn-xs">详情</a>
												<a href="${pageContext.request.contextPath}/user/findUserRoles/${user.id}" class="btn bg-olive btn-xs">更改角色</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
		...
		<script>
			...
			function deleteUserByIds(){
				...
				//alert(arr);
				location.href="${pageContext.request.contextPath}/user/deleteById?ids="+arr;
			}
