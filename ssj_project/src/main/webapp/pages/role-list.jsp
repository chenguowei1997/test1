                            ...
                            <c:forEach items="${roleList}" var="role">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="${pageContext.request.contextPath}/role/findRolePermission/${role.id}"
                                           class="btn bg-olive btn-xs">更改权限</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
...
<script>
    ...
    function deleteRoleByIds() {
        ...
        location.href = "${pageContext.request.contextPath}/role/deleteById?ids=" + arr;
    }
